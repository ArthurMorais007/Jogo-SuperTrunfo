...
namespace Jogo_SuperTrunfo
{
    public class Carta
    {
        ...
        public Carta(string nome, string classeRpg, string codigo, int forca, int velocidade, int resistencia, int mana, int inteligencia, int noblePhantasm, string frase, bool ehSuperTrunfo = false)
        {
            Nome = nome;
            ClasseRPG = classeRpg;
            Codigo = codigo;
